...
from core.utils import headers_to_dict
...
class ZhiHuOperator:
    ...
    def get_article_id(self, title):
        ...
        try:
            ...
            print(f"获取 art_id 失败: {e} {stack_trace}")
            return None
    ...
    def publish_content(self, tags: str, title: str, content: str) -> bool:
        ...
        if res.status_code == 200:
            ...
            if tag_result:
                ...
                if res_push.status_code == 200:
                    print(f"push {title} success, result: {res_push.text}")
                    return True
        return False
